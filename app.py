...
api_key=st.sidebar.text_input(label="Groq API Password", type="password")

if not db_uri:
    st.info("Please enter the database information and uri")

if not api_key:
    st.info("Please add the groq qpi key")
    st.stop()
...
agent=create_sql_agent(
    ...
    prefix="You are not allowed to perform DELETE, DROP, UPDATE, or INSERT queries."
)
